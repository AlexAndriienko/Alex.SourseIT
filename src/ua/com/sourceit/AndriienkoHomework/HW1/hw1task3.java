...
//Part3
//Ќаписать класс, который реализует функциональность определени€ наибольшего общего делител€ двух целых положительных чисел, 
...
public class hw1task3 {
	public static void main(String[] args) {
		...
		System.out.println("Ќаибольший общий делитель равен: " + x);	
	}
