...
public class HW13_Task4_Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Max: " + max + ". Time for finding Max value by single \"for i\" method: " + ((endTime - startTime) / 1000) + " ms;");
		
		long startTime2 = System.nanoTime();
		int max2 = new HW13_Task4_MultithreadingMax().multithreadinMaxDetermination(matrix);
		long endTime2   = System.nanoTime();
		
		System.out.println("Max: " + max2 + ". Time for finding Max value by multithreading method: " + ((endTime2 - startTime2) / 1000) + " ms;");
